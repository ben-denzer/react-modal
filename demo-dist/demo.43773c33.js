...
},{"object-assign":13,"fbjs/lib/invariant":14,"fbjs/lib/emptyObject":15,"fbjs/lib/emptyFunction":16}],17:[function(require,module,exports) {
/**
...
},{"fbjs/lib/invariant":14,"fbjs/lib/warning":17,"./lib/ReactPropTypesSecret":26}],7:[function(require,module,exports) {
/** @license React v16.3.2
...
},{"object-assign":13,"fbjs/lib/invariant":14,"fbjs/lib/emptyObject":15,"fbjs/lib/warning":17,"fbjs/lib/emptyFunction":16,"prop-types/checkPropTypes":18}],4:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react.production.min.js":6,"./cjs/react.development.js":7}],19:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/invariant":14,"react":4,"fbjs/lib/ExecutionEnvironment":19,"object-assign":13,"fbjs/lib/emptyFunction":16,"fbjs/lib/getActiveElement":20,"fbjs/lib/shallowEqual":21,"fbjs/lib/containsNode":22,"fbjs/lib/emptyObject":15}],29:[function(require,module,exports) {
'use strict';
...
},{"fbjs/lib/invariant":14,"react":4,"fbjs/lib/warning":17,"fbjs/lib/ExecutionEnvironment":19,"object-assign":13,"fbjs/lib/emptyFunction":16,"prop-types/checkPropTypes":18,"fbjs/lib/getActiveElement":20,"fbjs/lib/shallowEqual":21,"fbjs/lib/containsNode":22,"fbjs/lib/emptyObject":15,"fbjs/lib/hyphenateStyleName":24,"fbjs/lib/camelizeStyleName":23}],5:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react-dom.production.min.js":8,"./cjs/react-dom.development.js":9}],25:[function(require,module,exports) {
"use strict";
...
exports.ICustomModalStyle = undefined;
...
var Modal = /** @class */function (_super) {
    ...
    Modal.prototype.calculateButtonStyle = function (closeButton, closeButtonHover, closeButtonText, hoveredButtonText) {
        ...
        var button = buttonIsHovered ? __assign({}, closeButton, closeButtonHover) : closeButton;
        var buttonText = buttonIsHovered ? __assign({}, closeButtonText, hoveredButtonText) : closeButtonText;
        return { button: button, buttonText: buttonText };
    };
    Modal.prototype.mergeStyles = function () {
        var custom = this.props.customStyle;
        var merged = __assign({}, _ModalStyles.modalStyle);
        for (var i in custom) {
    ...
    Modal.prototype.setAnimationTime = function () {
        ...
        return _ModalStyles.modalStyle.animationTime;
    };
    Modal.prototype.toggleModalClass = function (shouldShowModal) {
        ...
        setTimeout(function () {
            return _this.setState({ modalClassName: nextClass });
        }, timer);
    };
    Modal.prototype.render = function () {
        ...
        return React.createElement("div", { style: bgStyle, id: "modal-modalBackground", onClick: this.closeOnBgClick }, React.createElement("div", { id: "modal-modalInner", style: modalInner }, React.createElement("div", { id: "modal-modalHeader", style: modalHeader }, React.createElement("div", { id: "modal-modalTitle", style: modalTitle }, this.props.title), React.createElement("div", { id: "modal-closeButton", onClick: this.props.closeModal, onMouseOut: this.buttonMouseOut, onMouseOver: this.mouseOverButton, style: button }, React.createElement("span", { style: buttonText, id: "modal-closeButtonText" }, "X"))), React.createElement("div", { id: "modal-modalBody", style: modalBody }, this.props.children)));
    };
    Modal.defaultProps = {
        customStyle: {}
    };
...
exports.ICustomModalStyle = _ModalStyles.ICustomModalStyle;
exports.default = Modal;
},{"react":4,"./ModalStyles":25}],10:[function(require,module,exports) {
module.exports="/lightBg.7d0b0978.jpg";
},{}],11:[function(require,module,exports) {
module.exports="/react.df21af3a.png";
...
var bgImage = require('../img/lightBg.jpg');
var reactLogo = require('../img/react.png');
var mainDivStyle = {
    textAlign: 'center',
    fontFamily: 'Arial, Helvetica, sans-serif'
};
var App = /** @class */function (_super) {
    ...
    App.prototype.openModal = function (e) {
        var id = e.target.id;
        var customizedModal = id === 'demo-customizedModal';
        this.setState({ customizedModal: customizedModal, shouldShowModal: true });
    };
    App.prototype.render = function () {
        ...
        var modalStyle = this.state.customizedModal ? customStyle : {};
        return React.createElement(React.Fragment, null, React.createElement(_Modal2.default, { closeModal: this.closeModal, customStyle: modalStyle, shouldShowModal: this.state.shouldShowModal, title: "Modal Demo" }, React.createElement("div", null, "This is @bdenzer/react-modal. You can put any React Component in this body section."), this.state.customizedModal && React.createElement(React.Fragment, null, React.createElement("img", { style: { margin: '20px auto' }, src: reactLogo, alt: "React Logo" }), React.createElement("div", null, React.createElement("strong", null, "Hover over the close button at the top right of the modal")), React.createElement("p", null, "Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of \"de Finibus Bonorum et Malorum\" (The Extremes of Good and Evil) by Cicero, written in 45 BC. This book is a treatise on the theory of ethics, very popular during the Renaissance. The first line of Lorem Ipsum, \"Lorem ipsum dolor sit amet..\", comes from a line in section 1.10.32."), React.createElement("p", null, "The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from \"de Finibus Bonorum et Malorum\" by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham."), React.createElement("p", null, "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like)."), React.createElement("p", null, "There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words."))), React.createElement("div", { style: mainDivStyle }, React.createElement("h1", null, "@bdenzer/react-modal Demo"), React.createElement("p", null, "The default styles are made to look like Bootstrap's modal"), React.createElement("button", { id: "demo-button", onClick: this.openModal }, "Open Default Modal"), React.createElement("p", null, "But you can easily customize just about everything about it. Here is an example of some of the things you could do."), React.createElement("button", { id: "demo-customizedModal", onClick: this.openModal }, "Open Customized Modal")));
    };
    return App;
}(React.Component);
exports.default = App;
},{"react":4,"../../src/Modal/Modal":12,"../img/lightBg.jpg":10,"../img/react.png":11}],2:[function(require,module,exports) {
'use strict';
...
},{"react":4,"react-dom":5,"./components/App":3}],31:[function(require,module,exports) {
...
//# sourceMappingURL=/demo.43773c33.map